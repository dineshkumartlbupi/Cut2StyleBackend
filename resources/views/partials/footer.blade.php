        ...
        <div class="row g-4 justify-content-between">
                    ...
                    <div class="col-6 col-md-3" style="border-left: 1px solid #262626;padding-left: 1.5rem;">
                        ...
                        <ul class="list-unstyled mb-6 mb-md-8 mb-lg-0 pt-6">
                            <h6 class="text-uppercase footerheading mt-3 mb-2" id="app-logo">
                                <img src="{{asset('assets/images/footer/download-app.png')}}" alt="logo"
                                    style="width: 45px;border-radius: 4px; margin-right: 8px;">
                                Download App
                            </h6>
                            <a href="#" target="_blank"><img src="{{asset('assets/images/footer/appstore.png')}}"
                                    class="imageapp pb-2"> </a>
                            <a href="#" target="_blank"><img src="{{asset('assets/images/footer/playstore.png')}}"
                                    class="imageapp"> </a>
                        </ul>
                    </div>
                </div>
            ...
            <div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
                ...
                <div class="text-body" style="font-size: 13px;color: #5c5c5c !important;"> Copyrights &copy;2025
                    Cut2Style.com. &nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="text-body text-primary-hover"
