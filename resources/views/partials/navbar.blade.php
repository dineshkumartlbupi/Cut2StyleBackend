...
<nav class="navbar navbar-expand-lg bg-white sticky-top navbar-inverse">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="index.html">
            <img src="{{asset('assets/images/logos.png')}}" class="navbar-brand-img" alt="cut2style Logo"
                style="margin-left: 1.9%;position: relative;top: -18px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="navbar-nav ms-auto">
                            ...
                            <div class="col-5">
                                <div class="row gx-0">
                                    <div class="col-12 col-lg-6">
                                        <h6 class="dropdown-header"><em style="text-transform: capitalize;">Bee</em>Pro
                                        </h6>
                ...
                <li class="nav-item ">
                    <a class="nav-link book" href="/login">Sign in</a>
                </li>
                <li class="nav-item ">
