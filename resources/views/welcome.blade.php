...
<section id="services">
    ...
    <div class="container">
        <div class="col-12 pt-5 pt-md-8 text-center">
            <h2 class="fw-bold">Our <em>Bee</em>Pro {{ $category->name }} at Your Doorstep</h2>
        </div>



            <div class="flickity-viewport-visible pb-5"
                data-flickity='{"cellAlign": "left", "imagesLoaded": true, "pageDots": false, "prevNextButtons": true, "contain": true, "groupCells": 3}'>

                @foreach($category->services as $service)
                    <div class="col-12 col-md-4">
                        <div class="card card-border shadow-light-lg lift lift-lg h-100" style="border-top-color: #fff;">
                            <div class="card-body text-center d-flex flex-column justify-content-between">

                                {{-- Service image --}}
                                <div class="mb-3">
                                    @if($service->image)
                                        <img src="{{ asset('storage/' . $service->image) }}" class="img-fluid rounded" alt="{{ $service->name }}" style="height: 180px; object-fit: cover;">
                                    @else
                                        <img src="https://via.placeholder.com/220x140?text=No+Image" class="img-fluid rounded" alt="No Image">
                                    @endif
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="card-text text-success fw-bold">₹{{ number_format($service->price, 2) }}</p>
                                </div>
                                ...
                                <div class="d-flex justify-content-center gap-2 mt-3">
                                    ...
                                    {{-- Uncomment this when routing is ready --}}
                                    {{-- <a href="{{ route('service.details', ['id' => $service->id]) }}" class="btn btn-sm btn-outline-secondary">View Details</a> --}}
                                </div>
    ...
    <section id="prosbee">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="flickity-viewport-visible pt-2 pb-5"
                        data-flickity='{"cellAlign": "left", "imagesLoaded": true, "pageDots": false, "prevNextButtons": true, "contain": true, "groupCells": 3}'>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="card card-border shadow-light-lg lift lift-lg h-100" style="border-top-color: #fff;">
                                    <div class="card-body text-center d-flex flex-column justify-content-between">
                                        ...
                                        <div class="mb-3">
                                            @if($product->image)
                                                <img src="{{ asset('storage/' . $product->image) }}" class="img-fluid rounded" alt="{{ $product->name }}" style="height: 180px; object-fit: cover;">
                                            @else
                                                <img src="https://via.placeholder.com/220x140?text=No+Image" class="img-fluid rounded" alt="No Image">
                                            @endif
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-center gap-2 mt-3">
                                            ...
                                            <a href="#" class="btn btn-sm btn-outline-secondary">View Details</a>
                                            {{-- Uncomment and use the route when ready --}}
                                            {{-- <a href="{{ route('product.details', ['id' => $product->id]) }}" class="btn btn-sm btn-outline-secondary">View Details</a> --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
