                    ...
                    t.exports = {
                        ...
                        parse: function (e) {
                            ...
                            for (var i = 0; i < t.length; i++) {
                                ...
                                (r[this.unsbjs(t[i])] = {}),
                                    (s = this.get(t[i])
                                        ? this.get(t[i]).split(n)
                                        : []);
                                for (var o = 0; o < s.length; o++) {
                                    var c = s[o].split("="),
                                        u = c.splice(0, 1);
                                    u.push(c.join("=")),
                                        (r[this.unsbjs(t[i])][u[0]] =
                                            this.decodeData(u[1]));
                                }
                            }
                            return r;
                ...
                function (e, t, r) {
                    ...
                    t.exports = function (e) {
                        ...
                        function H(e) {
                            ...
                            return (
                                s.getHost(e) !==
                                s.getHost(document.location.href)
                            );
                        }
                        function D() {
                            i.set(
                            ...
                            i.set(
                                ...
                                (function () {
                                    ...
                                    if (
                                        ...
                                        "undefined" !=
                                            typeof k.utm_source_platform ||
                                        "undefined" !=
                                            typeof k.utm_creative_format ||
                                        "undefined" !=
                                            typeof k.utm_marketing_tactic ||
                                        "undefined" != typeof k.gclid ||
                                        "undefined" != typeof k.yclid ||
                                        "undefined" !=
                                            typeof k[x.campaign_param] ||
                    ...
                    t.exports = {
                        go: function (e, t, r) {
                            var i,
                                ...
                                o = { l: e, d: t, i: r };
                            if (
                                a.get(n.containers.first) ||
                                a.get(n.service.migrations)
                            ) {
                                ...
                                go: function (e, t) {
                                    ...
                                    try {
                                        ...
                                        for (var c in n.containers)
                                            n.containers.hasOwnProperty(c) &&
                                                o.push(n.containers[c]);
                ...
                function (e, t, r) {
                    ...
                    t.exports = {
                        fetch: function (e) {
                            ...
                            if (
                                ((r.lifetime =
                                    this.validate.checkFloat(t.lifetime) || 6),
                                (r.lifetime = parseInt(
                                    30 * r.lifetime * 24 * 60
                                )),
                                (r.session_length =
                                    this.validate.checkInt(t.session_length) ||
                                    30),
                                (r.timezone_offset = this.validate.checkInt(
                                    t.timezone_offset
                                )),
                                (r.base64 = t.base64 || !1),
                                ...
                                t.promocode
                                    ? ((r.promocode = {}),
                                      (r.promocode.min =
                                          parseInt(t.promocode.min) || 1e5),
                                      (r.promocode.max =
                                          parseInt(t.promocode.max) || 999999))
                                    : (r.promocode = !1),
                                t.typein_attributes &&
                                ...
                                for (var i = 0; i < t.referrals.length; i++)
                                    t.referrals[i].host &&
                                        r.referrals.push(t.referrals[i]);
                            if (
                                ((r.organics = []),
                        ...
                        validate: {
                            checkFloat: function (e) {
                                return (
                                    !(!e || !this.isNumeric(parseFloat(e))) &&
                                    parseFloat(e)
                                );
                            },
                            checkInt: function (e) {
                                return (
                                    !(!e || !this.isNumeric(parseInt(e))) &&
                                    parseInt(e)
                                );
                            },
