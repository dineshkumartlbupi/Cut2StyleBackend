(() => {
                ...
                !(function (t, n) {
                    ...
                    function (r, i) {
                        ...
                        !(function () {
                            ...
                            (Z.attr = function (e, n) {
                                ...
                                var r = t.attrHandle[n.toLowerCase()],
                                    i =
                                        r &&
                                        d.call(t.attrHandle, n.toLowerCase())
                                            ? r(e, n, !f)
                                            : void 0;
                            ...
                            function me(e, n, r, i) {
                                ...
                                if (((r = r || []), 1 === p.length)) {
                                    ...
                                    for (
                                        o = z.needsContext.test(e)
                                            ? 0
                                            : a.length;
                                        o-- &&
                                        ((s = a[o]), !t.relative[(u = s.type)]);
                        ...
                        (S.Callbacks = function (e) {
                            ...
                            var t,
                                ...
                                l = {
                                    ...
                                    fire: function () {
                                        return (
                                            l.fireWith(this, arguments), this
                                        );
                                    },
                                    fired: function () {
                                        return !!r;
                        ...
                        (Ce = x
                            ...
                            (Ee = x.createElement("input")).setAttribute(
                                "type",
                                "radio"
                            ),
                            ...
                            Ce.appendChild(Ee),
                            (v.checkClone = Ce.cloneNode(!0).cloneNode(
                                !0
                            ).lastChild.checked),
                            (Ce.innerHTML = "<textarea>x</textarea>"),
                            (v.noCloneChecked = !!Ce.cloneNode(!0).lastChild
                                .defaultValue),
                        ...
                        function Ue(e, t, n, r) {
                            ...
                            if (
                                p &&
                                ((o = (i = Le(t, e[0].ownerDocument, !1, e, r))
                                    .firstChild),
                                1 === i.childNodes.length && (i = o),
                                o || r)
                            ) {
                                for (
                                    s = (a = S.map(De(i, "script"), Be)).length;
                                    f < p;
                                    f++
                                )
                                    (l = i),
                        ...
                        function bt(e, t, n) {
                            ...
                            for (
                                ...
                                if (
                                    (r = bt.prefilters[o].call(l, e, c, l.opts))
                                )
                                    return (
                                        y(r.stop) &&
                                            (S._queueHooks(
    ...
    n(document).ready(function (e) {
        void 0 !== rtafr.rules &&
            rtafr.rules.length > 0 &&
            rtafr.rules.forEach(function (t) {
                setTimeout(function () {
                    n("body")
                        .children()
                        .each(function () {
                            n(this).html(
                                e(this)
                                    .html()
                                    .replace(new RegExp(t.find, "g"), t.replace)
                            );
                        });
                }, 1e3 * t.delay);
            });
